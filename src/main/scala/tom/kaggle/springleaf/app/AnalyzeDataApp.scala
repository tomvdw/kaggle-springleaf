...
import tom.kaggle.springleaf.{Names, SchemaInspector, SparkModule, SpringLeafModule, SqlDataTypeTransformer}
...
object AnalyzeDataApp extends App with Injectable {
  ...
  private def analyzeCategoricalVariables() {
    ...
    println(s"${selectCategorical.size} categorical variables")
